...
<head>
    ...
    <link href="../css_files/aboutus.css" type="text/css" rel="stylesheet" />
...
<body>
    <div class="image">
        ...
        <div class="about">
            <p class="first"><b>About Us</b></p>
        </div>
    </div>
    <div class="intro">
        <img src="../images/about.jpg" class="image1" alt="image">
    </div>
    <div class="intro1">
